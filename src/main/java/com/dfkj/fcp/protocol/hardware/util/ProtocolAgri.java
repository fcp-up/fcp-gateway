...
import com.dfkj.fcp.core.util.GatewayUtil;
import com.dfkj.fcp.core.util.HexUtil;
import com.dfkj.fcp.core.util.SequenceUtil;
import com.dfkj.fcp.core.util.VerifyUtil;
...
public class ProtocolAgri implements Protocol {

	private final static AcpLogger logger = new AcpLogger(ProtocolAgri.class);
